  ...
  return <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            {product.image && <img src={product.image} alt={product.name} className="w-full rounded-lg shadow-lg" />}
          </div>
            ...
            {variants.length === 0 ? <Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {storageOptions.length > 0 && <div className="space-y-2">
                    ...
                    {modelOptions.length > 0 && <div className="space-y-2">
                        <Label>Modell</Label>
                        <Select value={selectedModel} onValueChange={setSelectedModel}>
                          ...
                          <SelectContent className="bg-popover z-50">
                            {modelOptions.map(model => <SelectItem key={model} value={model}>
                                {model}
                              </SelectItem>)}
                          </SelectContent>
                        </Select>
